<nav class="w-64 bg-gray-800 text-white flex flex-col p-4 space-y-4">
    ...
    <a href="{{ route('admin.payment') }}" class="flex items-center px-3 py-2 rounded-md hover:bg-gray-700 space-x-2">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path stroke-linecap="round" stroke-linejoin="round" d="M17 9V7a4 4 0 00-8 0v2M5 12h14m-4 6h1"></path>
        </svg>
        <span>Payment</span>
    </a>
