                ...
                <form action="/submit" method="POST" class="space-y-3">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div class="flex flex-col">
                            <label for="client_id" class="text-gray-700 font-medium">Username</label>
                            <input type="number" id="client_id" name="client_id" class="p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 w-full text-sm" placeholder="">
                        </div>
                    </div>
                    <div class="grid grid-cols-1 gap-4">
                        <div class="flex flex-col">
                            <label for="amount" class="text-gray-700 font-medium">Password</label>
                        ...
                        <div class="flex flex-col">
                            <label for="amount" class="text-gray-700 font-medium">Confirm Password</label>
                            <input type="number" id="amount" name="amount" class="p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 w-full text-sm" placeholder="">
                        </div>
                    </div>
                    <div class="grid grid-cols-1 gap-4">
                        <div class="flex flex-col">
                            <label for="due_date" class="text-gray-700 font-medium">Role</label>
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div class="flex flex-col">
                            <label for="client_id" class="text-gray-700 font-medium">Branch</label>
