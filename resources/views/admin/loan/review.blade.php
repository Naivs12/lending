...
<div class="m-6 h-full" id="main_content">
    <div class="card-container relative overflow-hidden h-full">
        ...
        <div class="flex justify-start mb-3 mt-3 w-full">
            <form method="GET" action="{{ route('admin.loan.review') }}" class="w-full">
                ...
                <tbody>
                    ...
                    @else
                        ...
                        <tr class="cursor-pointer hover:bg-gray-100 user-row" onclick="redirectToLoanDetail('{{ $loan->loan_id }}')">
                            ...
                            <td class="px-4 py-2 whitespace-nowrap items-center">{{ number_format($loan->loan_amount, 2) }}</td>
